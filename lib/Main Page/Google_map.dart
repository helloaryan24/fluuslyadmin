...
class _MapScreenState extends State<MapScreen> {
  ...
  Future<void> getCurrentLocation() async {
    try {
      ...
      if (currentLocation != null) {
        ...
        controller.updateLocation(currentLocation!, "My Location"); // Correct call to controller
      }
    } catch (e) {
  ...
  Future<void> getPlaceSuggestions(String input) async {
    ...
    List<String> countryCodes = ['us', 'gb', 'in', 'uk' , 'ca']; // Add more as needed
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: AppColors.gradientcolor1,title: Text("Google Map", style: TextStyles.Montserratbold11),),
      ...
      floatingActionButton: GestureDetector(
        ...
        child: Container(
            ...
            child: Text("OK",style: TextStyles.Montserratbold6)
        ),
      ),
      body: Stack(
        children: [
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) {
              ...
              // No need to call controller.updateLocation here
            },
