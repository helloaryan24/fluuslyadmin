...
//     if (!serviceEnabled) {
//       // Location services are not enabled, do something (e.g., prompt the user to enable it)
//       return;
//     }
//
...
//       if (permission == LocationPermission.denied) {
//         // Permissions are denied, do something (e.g., show a dialog)
//         return;
//       }
//     }
//
...
//     );
//
//     // Check if placemarks are not empty
//     if (placemarks.isNotEmpty) {
//       Placemark place = placemarks.first;
//       // Update the current location with the name, area, and city
//       currentLocation.value = "${place.name}, ${place.subLocality}, ${place.locality}";
//       isLocationFetched.value = true;
//       print("${place.name}, ${place.subLocality}, ${place.locality} ${position.latitude} ${position.longitude}");
//       Get.back();
//       // Navigate to the next page
//       // Get.offAndToNamed('/BottomBar_Page');
//     } else {
//       currentLocation.value = "Location details not available";
//     }
//   }
//
//   @override
